...
const CACHE_NAME = "see-static-v34";
const ROOT = new URL("./", self.registration.scope).href;
const APP_SHELL = [
  ROOT,
  new URL("./index.html", ROOT).href,
  new URL("./styles.css?v=34", ROOT).href,
  new URL("./app.js?v=34", ROOT).href,
  new URL("./image-engine.js?v=34", ROOT).href,
  new URL("./s01-classic-neg-lut.js?v=34", ROOT).href,
  new URL("./s02-classic-chrome-lut.js?v=34", ROOT).href,
  new URL("./manifest.webmanifest?v=34", ROOT).href,
  new URL("./apple-touch-icon.png?v=34", ROOT).href,
